...
public class PnlAnimal extends javax.swing.JPanel {
    private Persistencia persistencia = new AnimalDao(); //criei para usar a interface
    ...
    public void habilitar() {
        ...
        txtRaca.setEditable(true); //prestar atencao ao EDITABLE
    ...
    public void desabilitar() {
        txtNome.setEditable(false);
        txtRaca.setEditable(false); //prestar atencao ao EDITABLE
        txtIdade.setEditable(false);
        txtPeso.setEditable(false);
